...
.box > .icon > .image { position: relative; z-index: 2; margin: auto; width: 66px; height: 66px; border: 8px solid white; line-height: 66px; border-radius: 50%; background:#837e7e; vertical-align: middle; }
...
.box > .icon:hover > .info > h4.title, .box > .icon:hover > .info > p, .box > .icon:hover > .info > .more > a { color: #222; }
