	...
	<div class="col-md-12">
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title">AAdhar Card Report</h3>
			</div>
			<!------		Button 	----->
			<div class="row">
			<div class="col-md-12">
			...
			<div class="col-md-3" >
					...
					<h3>AAdhar Card report</h3>
					<div class="input-group">
						<select class="form-control select2me" id="suv_category">
							<option value="">Select...</option>
							<?php
								$service1=mysql_query("select name,id from `register` where aadhar_card_no!='' &&`flag`='0'");
...
var from = $("#from").val();
		...
		$.ajax({
			url: "date_vise_aadhar_card_report.php?from="+from+"&to="+to+"",
...
<script>
	...
	$("#suv_category ").on("change",function(){
		...
		$.ajax({
			url: "aadhar_card_report1.php?pon="+s,
			}).done(function(response) {
				$("#data").html(""+response+"");
		});
	});	
